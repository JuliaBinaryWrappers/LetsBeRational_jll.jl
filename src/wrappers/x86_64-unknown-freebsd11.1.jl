# Autogenerated wrapper script for LetsBeRational_jll for x86_64-unknown-freebsd11.1
...
const libletsberational_splitpath = ["lib", "libletsberational.so"]
...
const libletsberational = "libletsberational.so"

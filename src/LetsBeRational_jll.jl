...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LetsBeRational_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b1162f8a-ee7e-515c-ae1d-7fab3c0ab9f7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LetsBeRational", artifacts_toml) for e in artifacts["LetsBeRational"]]
...
if best_platform === nothing
    @debug("Unable to load LetsBeRational; unsupported platform $(triplet(platform_key_abi()))")
else
